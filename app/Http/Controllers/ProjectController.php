...
{
    public function __construct(protected \App\Services\ProjectService $projectService) {}
    ...
    public function index(Request $request)
    {
        ...
        $query = $this->projectService->buildFilteredQuery($request->all());
    ...
    public function show(Request $request, Project $project)
    {
        ...
        try {
            return new ProjectResource($project->load(['manager', 'teams']));
        } catch (\Exception $e) {
